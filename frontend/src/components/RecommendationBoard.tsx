                    ...
                    {effectiveBoardMode === 'engine'
                      ? rankedRecommendations.map((recommendation, index) => (
                          <PlayerBoardRow
                            ...
                            onDraftPlayer={draftInit.provider !== 'yahoo' && onDraftPlayer ? () => onDraftPlayer(recommendation.playerId) : undefined}
                          />
                        ))
                      : marketRows.map((row, index) => (
                          <PlayerBoardRow
                            ...
                            onDraftPlayer={draftInit.provider !== 'yahoo' && onDraftPlayer ? () => onDraftPlayer(row.playerId) : undefined}
                          />
                        ))}
                  </BoardRows>
                ) : (
